...
1. <계산양식>에 따라 필요한 맨먼스를 예측합니다. (프론트엔드 개발자, 백엔드 개발자, 디자이너, 기획자 ,PM)
2. 1MM = 30days
3. 반드시 아래 JSON 형식으로만 응답하세요.
4. 별도 내용이 없다면 기획,개발,디자인이 다 필요하다고 가정합니다.
...
`;
// 1. 간단한 서비스라면 2주~1개월, 새로운 앱/웹 구축 이라면 3개월~4개월, 복잡한것들은 6개월~1년으로 분류
// 최소 기준: "각 인력의 맨먼스,견적"\n 고급 기준: "각 인력의 맨먼스,견적"\n
